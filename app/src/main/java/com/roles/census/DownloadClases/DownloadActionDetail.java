...
import com.roles.census.Activities.Licensing.LicensingActionActivity;
...
public class DownloadActionDetail {
    ...
    public DownloadActionDetail(Context context, String HCEName, String final_id, String email, String password, String username, String isEdit , String index, int count, String  latLngInput){
