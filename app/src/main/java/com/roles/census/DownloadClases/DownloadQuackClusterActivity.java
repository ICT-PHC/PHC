package com.roles.census.DownloadClases;
...
public class DownloadQuackClusterActivity {
    ...
    String sectortypetext, counciltypetext, hceTypetext, hcestatusID, districtText, tehsilText, distancetext, BfromText, BtoText, lastvisitedID, RegnoText, hcenameText, email, password, username, isEdit, finalidText, actionText,subactionTypeID;
    public DownloadQuackClusterActivity(Context context,String sectortypetext,String counciltypetext,String hceTypetext,String hcestatusID,String districtText,String tehsilText,String distancetext,String BfromText,String BtoText,String lastvisitedID,String subactionTypeID,String RegnoText,String hcenameText,String email,String password,String username,String isEdit,String finalidText,String actionText) {
