...
import com.roles.census.Activities.Common.UpdateBasicInfoActivity;
import com.roles.census.TabsActivities.DetailTabActivity;
...
public class DownloadHCEDetail {
    ...
    String UserName,LastVisitedDate, HCEName, HCEAddress, District, SectorType, OrgType, HCSPType, HCSPName, HCSPSO ,HCSPCNIC ,HCSPContactNo ,RegStatus ,RegNum ,CouncilStatus ,CouncilName ,CouncilNum,RegType,index,total_beds,RegTypebit;
