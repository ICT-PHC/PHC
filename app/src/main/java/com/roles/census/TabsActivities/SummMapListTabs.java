...
import com.roles.census.Fragments.HCEListFragment;
import com.roles.census.Extra.HomeFragment;
import com.roles.census.Fragments.MapFragment;
...
import com.roles.census.Fragments.NotRegClusterListFragment;
import com.roles.census.Fragments.QuackClusterListFragment;
import com.roles.census.Fragments.summaryFragment;
...
*//*
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Do you want to go back to the home page?")
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // User clicked Yes button
                        Intent intent = new Intent(SummMapListTabs.this, FilterActivity.class);
