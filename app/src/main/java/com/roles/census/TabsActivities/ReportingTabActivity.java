...
import com.roles.census.Fragments.ClosedSealedFragment;
import com.roles.census.Fragments.FunctionalSealedFragment;
import com.roles.census.Extra.HomeFragment;
import com.roles.census.Fragments.NotSealedFragment;
...
public class ReportingTabActivity extends AppCompatActivity {
    ...
    String NotSealedID,NotSealed,NotSealedcount,CloseSealedID,CloseSealed,ClosedSealedcount,PlanID,index,team,totalvisits,totalfir,startdat,enddate,FunctionalSealedID,FunctionalSealed,FunctionalSealedcount;
    String appURI = "";
    String time1;
    String password;
    String isEdit;
