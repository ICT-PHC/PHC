package com.roles.census.Activities.Aqc;
...
import com.roles.census.Adapters.ActionHistoryAdapter;
...
//    String total_beds="";
  ...
  //  double longitude;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.action_history_list);
        context = this;
  ...
  /*      BottomNavigationView navigation = (BottomNavigationView) findViewById(R.id.navigation);
        ...
        activityTitles = getResources().getString(R.string.nav_item_action_history);
...
// ...
        ...
        protected void onPostExecute(final ArrayList<HashMap<String, String>> result) {
            ...
            if(result!=null && result.size()>0) {
                ActionHistoryAdapter adapter = new ActionHistoryAdapter(context, result,hce_nameText, email, password, username, isEdit,index);
