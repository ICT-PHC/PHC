...
import com.roles.census.Adapters.MyCustomPagerAdapter;
...
import com.roles.census.DownloadClases.DownloadActionDetail;
...
/*        String Division="Please Select";
    ...
    private String getDirectionsUrl(Context context) {
        ...
        String token=context.getResources().getString(R.string.token); //add latlng below
        String url=baseurl+"UpdateHCEBasicInfo?strToken="+token+"&HCEName="+hce_nameText+" latLngInput="+ latLngInput+"&HCEAddress="+AddressText+"&District="+districtText+"&SectorType="+sectortypetext +
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                if (MID.equals("1")) {
                    ...
                    DownloadActionDetail downloadActionDetail = new DownloadActionDetail(context,hce_nameText, final_id, email, password, username, isEdit, index, countt,  latLngInput);  // add latlng
