...
import com.roles.census.Activities.Inspection.InspectionFilterActivity;
...
public class Login_Activity extends AppCompatActivity {
    ...
    //    sharedPreferences = getSharedPreferences("LoginPrefs", MODE_PRIVATE); // Add this
...
////////////////////////////////////////////////district////////////////////////////////////////
   ...
   /* private void setLoggedIn(boolean loggedIn) {  // Add this
        emailEditor = sharedPreferences.edit();
        emailEditor.putBoolean("isLoggedIn", loggedIn);
        emailEditor.apply();
    }

    private boolean isLoggedIn() {  // Add this
        return sharedPreferences.getBoolean("isLoggedIn", false);
    }

    private void startHomeActivity() {  // Add this
