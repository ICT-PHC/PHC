...
import com.roles.census.Adapters.FunctionalSealedAdapter;
...
public class SealingSubTypesActivity extends AppCompatActivity {
...
//    String total_beds="";
  ...
  //  double longitude;
    ...
    Calendar myCalendar;
    EditText comments;
    String PlanTitle,ActionID,SubActionname,ActionName;
    int actionposition;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sealing_subtype_list);
        context = this;
      ...
      hce_name = (TextView) findViewById(R.id.hce_name);
        ...
        ActionID = (String) intent.getSerializableExtra("ActionID");
        SubActionname = (String) intent.getSerializableExtra("SubActionname");
        indtabresult = (ArrayList<HashMap<String, String>>)intent.getSerializableExtra("result");
        if(ActionID.equals("1")){
            ActionName="Functional Sealed";
        }else if(ActionID.equals("2")){
            ActionName="Sealing Not Required";
        }else if(ActionID.equals("3")){
            ActionName="Close Sealed";
        }
        hce_name.setText(ActionName+": "+SubActionname);
  ...
  /*      BottomNavigationView navigation = (BottomNavigationView) findViewById(R.id.navigation);
        ...
        FunctionalSealedAdapter adapter = new FunctionalSealedAdapter(context,indtabresult, email, password, username, isEdit);
