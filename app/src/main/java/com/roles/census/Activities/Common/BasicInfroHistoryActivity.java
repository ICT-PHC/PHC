...
import com.roles.census.Adapters.BasicInfoHistoryAdapter;
...
public class BasicInfroHistoryActivity extends AppCompatActivity {
    ...
    ListView listView;
    String RoleID;
    TextView hce_nameView;
    @RequiresApi(api = Build.VERSION_CODES.M)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.basicinfo_history_list);
        context = this;
        ...
        hce_nameView = (TextView) findViewById(R.id.hce_name);
  ...
  /*      BottomNavigationView navigation = (BottomNavigationView) findViewById(R.id.navigation);
        ...
        activityTitles = getResources().getString(R.string.nav_InfoUpdate_History);
        ...
        hce_nameView.setText(final_id+" - "+hce_nameText);
...
*/
    ...
    private String getDirectionsUrl() {
        ...
        String url =null;
            ...
            url = baseurl + "GetHCEHistoricalData?strToken="+token+"&FinalID=" + final_id;
...
// ...
                    ...
                    for (int i = 0; i < json.length(); i++) {
                        ...
                        map.put("CorrectLoc", e.getString("CorrectLoc"));
                        map.put("CurrentLoc", e.getString("CurrentLoc"));
                        map.put("RemarksByPHCSurveyor", e.getString("RemarksByPHCSurveyor"));
        ...
        protected void onPostExecute(final ArrayList<HashMap<String, String>> result) {
            ...
            if(result!=null && result.size()>0) {
                BasicInfoHistoryAdapter adapter = new BasicInfoHistoryAdapter(context, result);
