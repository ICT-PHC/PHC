...
import com.roles.census.Managers.WebApiManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
              ...
              //  if (isLoggedIn()) {
                    // User is logged in, start home activity
...
// ...
        ...
        protected void onPostExecute(final ArrayList<HashMap<String, String>> result) {
            ...
            if (result != null && !result.isEmpty()) {
                HashMap<String, String> firstItem = result.get(0);

                GeneralRemarks = firstItem.get("GeneralRemarks");
                MobileAppVerCode = firstItem.get("MobileAppVerCode");
                MobileAppVerName = firstItem.get("MobileAppVerName");
                OutDated = firstItem.get("OutDated");
                PKID = firstItem.get("PKID");
                PortNo = firstItem.get("PortNo");
                Remarks = firstItem.get("Remarks");
                UploadDate = firstItem.get("UploadDate");
         ...
         /*   if ("true".equals(OutDated)) {
                        ...
                        .setPositiveButton("Update Now", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                try {
                                    ...
                                    intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.roles.census"));
                                    MainActivity.this.finish();
                                }
                            }
                        })
                ...
                if ("false".equals(OutDated))  {
                    progressBar.stopProgress();
                if (GeneralRemarks != null && !GeneralRemarks.equals("null")) {
                        Intent intent = new Intent();
                       intent.setClass(MainActivity.this,
                                Login_Activity.class);
                        MainActivity.this.startActivity(intent);
         ...
         /*   if (OutDated != null && OutDated.equals("false")) {
                // Skip splash screen and go to Login_Activity
                Intent intent = new Intent(MainActivity.this, Login_Activity.class);
                MainActivity.this.startActivity(intent);
                MainActivity.this.finish();}
            else if (OutDated != null && OutDated.equals("true")) {
                progressBar.stopProgress();
              ...
              Toast.makeText(context, "Play Store Server not responding! Please try again", Toast.LENGTH_SHORT).show();
                progressBar.stopProgress();
                progressBar.setVisibility(View.GONE);
                tryagain.setVisibility(View.VISIBLE);
            }
