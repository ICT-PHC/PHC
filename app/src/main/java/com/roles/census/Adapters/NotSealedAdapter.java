...
public class NotSealedAdapter extends BaseAdapter {
    Context context;
    String email;
    ...
    public NotSealedAdapter(Context context, ArrayList<HashMap<String, String>> arrayList, String actionid,String email, String password, String username, String isEdit) {
