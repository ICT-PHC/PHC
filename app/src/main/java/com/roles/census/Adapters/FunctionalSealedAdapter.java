...
public class FunctionalSealedAdapter extends BaseAdapter {
    Context context;
    String email;
    ...
    public FunctionalSealedAdapter(Context context, ArrayList<HashMap<String, String>> arrayList, String email, String password, String username, String isEdit) {
