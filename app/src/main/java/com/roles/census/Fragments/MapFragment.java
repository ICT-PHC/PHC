...
import com.roles.census.Activities.Common.RouteMapsActivity;
import com.roles.census.DataElements.MyItem;
import com.roles.census.DownloadClases.DownloadHCEDetail;
import com.roles.census.DataElements.District;
import com.roles.census.Others.CurrentLocation;
import com.roles.census.ParcelableModel.CarParcelable;
            ...
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(animateCurrent, 14));*/
                if(result!=null) {
                   ...
                   /*     List<LatLng> points=new ArrayList<LatLng>();
                        points.add(new LatLng(31.44501,	73.05452));
                        points.add(new LatLng(31.43733,	73.09306));
                        points.add(new LatLng(31.43322,	73.109));
                        points.add(new LatLng(31.41991,	73.12562));
                        points.add(new LatLng(31.40403,	73.12755));
                        points.add(new LatLng( 31.41697,	73.07239));
                        points.add(new LatLng(31.38219,	73.08418));
                        points.add(new LatLng( 31.45948,	73.14264));
                        points.add(new LatLng(31.4599,	73.10748));*/
