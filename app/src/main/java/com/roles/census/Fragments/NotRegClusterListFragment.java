...
import com.roles.census.Adapters.NotRegClusterAdapter;
import com.roles.census.R;
import java.util.ArrayList;
import java.util.HashMap;


public class NotRegClusterListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      ...
      NotRegClusterAdapter notRegClusterAdapter =new NotRegClusterAdapter(getContext(),indtabresult,email,password,username,isEdit,viewPager,mListener);
      listView.setAdapter(notRegClusterAdapter);
        notRegClusterAdapter.notifyDataSetChanged();
