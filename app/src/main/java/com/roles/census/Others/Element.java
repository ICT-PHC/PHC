...
public class Element {
     ...
     * {@link mehdi.sakout.aboutpage.Element#setIntent(Intent)} when both methods are used
     *
     ...
     *
     * @return
     * @see mehdi.sakout.aboutpage.Element#setIntent(Intent)
     */
     ...
     * {@link android.content.Context#startActivity(Intent)} method when this item
     * is clicked. This method has lower priority than
     * {@link mehdi.sakout.aboutpage.Element#setOnClickListener(View.OnClickListener)}
     * when both are used.
     *
