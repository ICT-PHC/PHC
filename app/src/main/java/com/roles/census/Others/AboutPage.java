package com.roles.census.Others;
...
public class AboutPage {
    ...
    public AboutPage(Context context) {
        ...
        this.mView = mInflater.inflate(R.layout.about, null);
    }
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addEmail(String, String)} but with
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addFacebook(String, String)} but with
     * a predefined title string
     *
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addTwitter(String, String)} but with
     * a predefined title string
     *
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addPlayStore(String, String)} but with
     * a predefined title string
     *
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addYoutube(String, String)} but with
     * a predefined title string
     *
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addInstagram(String, String)} (String, String)} but with
     * a predefined title string
     *
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addGitHub(String, String)} but with
     * a predefined title string
     *
    ...
    /**
     * Convenience method for {@link mehdi.sakout.aboutpage.AboutPage#addWebsite(String, String)} but with
     * a predefined title string
     *
    ...
    public AboutPage addGroup(String name) {
        ...
        TextViewCompat.setTextAppearance(textView, mehdi.sakout.aboutpage.R.style.about_groupTextAppearance);
    ...
    private View createItem(final Element element) {
        ...
        mContext.getTheme().resolveAttribute(mehdi.sakout.aboutpage.R.attr.selectableItemBackground, outValue, true);
        ...
        TextView textView = new TextView(mContext);
        TextViewCompat.setTextAppearance(textView, mehdi.sakout.aboutpage.R.style.about_elementTextAppearance);
        LinearLayout.LayoutParams textParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        textView.setLayoutParams(textParams);
        if (mCustomFont != null) {
            textView.setTypeface(mCustomFont);
